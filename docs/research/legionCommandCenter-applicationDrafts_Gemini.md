...
| **User Experience** | The purpose of the "Intel Map" charts isn't immediately obvious.   | Users may see the charts but not understand the strategic insight they are supposed to represent.                                       | Add a short, descriptive sentence below each chart's title explaining _what_ the user should learn from it. E.g., For "Loot Progression," add: "This visualizes how you'll turn free followers into high-value clients."                                              |
...
My audit identified a _symptom_ of the problem (that the Strategy Forge could be overwhelming) but my recommendation for a "guided mode" was an addition to the flawed tab structure, not a replacement for it.
